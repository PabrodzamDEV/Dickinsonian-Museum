...
urlpatterns = [
    ...
    path('essays/<int:pk>/update/', views.EssayUpdateView.as_view(), name='museum-essay-update'),
    path('essays/<int:pk>/delete/', views.EssayDeleteView.as_view(), name='museum-essay-delete'),
